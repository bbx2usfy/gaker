...
def train(modelConfig: Dict):
    ...
    # transforms是pytorch里面的一个组件，对图像进行处理
    ...
    #ImageFolder是一个数据集类，它用于加载图像数据
    src = r"D:\对抗样本实验复现代码\GAKer\Source images dataset"
    src_target = r"D:\对抗样本实验复现代码\GAKer\Target images dataset"
    ...
    if modelConfig["Source_Model"] == "ResNet50": 
        ...
        #将resnet50的特征提取哪个部分的东西拿出来，但是不用他的分类（我们是把特征提取出来然后放到生成器）
